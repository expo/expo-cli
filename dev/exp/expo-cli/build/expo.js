    ...
    return (_regenerator || _load_regenerator()).default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 11:
            message = 'There is a new version of expo-cli available (' + latest + ').\nYou are currently using expo-cli ' + current + '\nRun `npm install -g expo-cli` to get the latest version';
...
// Commands such as `expo start` and `expo publish` use this.
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 20:
              ...
              // This is relevant for command such as `expo send`
...
function runAsync() {
  try {
    ...
    (_xdl || _load_xdl()).Config.developerTool = 'expo-cli';

    // Setup our commander instance
    (_commander || _load_commander()).default.name = 'expo';
    (_commander || _load_commander()).default.version(require('../package.json').version).option('-o, --output [format]', 'set output format. pretty (default), raw');

    // Load each module found in ./commands by 'registering' it with our commander instance
    var files = (_lodash || _load_lodash()).default.uniqBy([].concat((0, (_toConsumableArray2 || _load_toConsumableArray()).default)((_glob || _load_glob()).default.sync('expo_commands/*.js', { cwd: __dirname })), (0, (_toConsumableArray2 || _load_toConsumableArray()).default)((_glob || _load_glob()).default.sync('commands/*.js', { cwd: __dirname }))), _path.default.basename);
    ...
    if (subCommand) {
      ...
      if (!(_lodash || _load_lodash()).default.includes(commands, subCommand)) {
        console.log('"' + subCommand + '" is not an expo command. See "expo --help" for the full list of commands.');
      }
    } else {
...
//# sourceMappingURL=__sourcemaps__/expo.js.map
