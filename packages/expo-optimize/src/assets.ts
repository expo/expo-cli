...
export async function optimizeAsync(
  ...
  console.log(chalk.green('Optimizing assets...'));
  ...
  for (const image of images) {
    ...
    if (amountSaved) {
      ...
      console.log(`Saved ${prettyBytes(amountSaved)}`);
    } else {
  ...
  if (totalSaved === 0) {
    ...
    console.log(`Finished compressing assets. ${chalk.green(prettyBytes(totalSaved))} saved.`);
  }
