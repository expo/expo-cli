...
import { withMainActivity } from '../../plugins/android-plugins';
import { getStatusBarTranslucent } from '../StatusBar';
import { addJavaImports } from '../UserInterfaceStyle';
import { getSplashConfig } from './SplashConfig';

export const withSplashMainActivity: ConfigPlugin = config => {
