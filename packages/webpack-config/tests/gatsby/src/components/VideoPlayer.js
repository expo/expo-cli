...
export default class VideoPlayer extends React.Component {
  ...
  _setPositionAsync = async position => this._video.setPositionAsync(position);

  _setIsLoopingAsync = async isLooping => this._video.setIsLoopingAsync(isLooping);

  _setIsMutedAsync = async isMuted => this._video.setIsMutedAsync(isMuted);
