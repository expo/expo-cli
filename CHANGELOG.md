...
- [xdl] Removed `Project.getManifestUrlWithFallbackAsync()` in favor of `UrlUtils.constructManifestUrlAsync()`
- [xdl] Removed `Project.getUrlAsync()` in favor of `UrlUtils.constructManifestUrlAsync()`
